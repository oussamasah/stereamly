...
export function ImportManager() {
  ...
  useEffect(()=>{automaticPreviewEnabled.current=contentKind==='LIVE'&&Boolean(sourceId);},[contentKind,sourceId]);
